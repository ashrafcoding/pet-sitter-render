...
import {
  ...
  getMyProfile,
  updateProfile,
} from "../../../helpers/APICalls/profiles";
...
const validationSchema = yup.object({
  ...
  phone: yup
    ...
    .matches(
      phoneRegExp,
      'Phone number is not valid (e.g., 1231231234 without "-")'
    )
  ...
  address: yup
    ...
    .matches(
      addressRegExp,
      "Address is not valid (e.g., City, Province (Comma is required))"
    )
            ...
            <>
              ...
              <Box display="flex" alignItems="center" className={classes.box}>
                ...
                <TextField
                  ...
                  onChange={formik.handleChange}
                  error={
                    formik.touched.hourlyWage &&
                    Boolean(formik.errors.hourlyWage)
                  }
                  helperText={
